...
public class StatManager : MonoBehaviour
{
    ...
    public void Heal(int value)
    {
        ...
        if (value > 0)
        {
            if (offStat.maxValue - hpslider.transform.localScale.x/100 * offStat.maxValue < value) //회복량이 잃은체력보다 크면
                hpslider.transform.localScale=new Vector3(100,hpslider.transform.localScale.y,hpslider.transform.localScale.z);
            else
                hpslider.transform.localScale=new Vector3(hpslider.transform.localScale.x+value/offStat.maxValue*100,hpslider.transform.localScale.y,hpslider.transform.localScale.z);
        }
        else
        {
            hpslider.transform.localScale=new Vector3(hpslider.transform.localScale.x+value/offStat.maxValue*100,hpslider.transform.localScale.y,hpslider.transform.localScale.z);
    ...
    public bool Hit(int value)  
    {
        ...
        float v = (value - (value * minusPer / 100f)) / offStat.maxValue;
    ...
    {
        hpslider.transform.localScale = new Vector2(hpslider.transform.localScale.x - value/offStat.maxValue*100, hpslider.transform.localScale.y);
        player.hpSync(hpslider.transform.localScale.x);
        if (hpslider.transform.localScale.x <= 0)
        {
            hpslider.transform.localScale=new Vector2(0,hpslider.transform.localScale.y);
    ...
    public int GetHp()
    {
        return (int) (offStat.maxValue * hpslider.transform.localScale.x);
    }
}
